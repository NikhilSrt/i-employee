...
import { Button, Avatar, Icon, SocialIcon, ItemData } from 'react-native-elements';
...
<TopContainer style={styles.imageContainer}>
<Image
   resizeMode= 'contain'
   style= {{flex:1}}
...
<Avatar
 ...
 <Text style={{color:'#fff', marginLeft:10, fontSize:20, fontFamily: 'Open-Sans-Bold'}}>{selectedCategory.Name}</Text>
 <Text style={{color:'#fff', marginLeft:10, fontSize:15, fontFamily: 'Open-Sans'}}>{selectedCategory.Post}</Text>
 </View>
 </View>
 <ScrollView>
 <LinearGradient 
